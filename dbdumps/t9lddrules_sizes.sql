...
INSERT INTO `sizes` VALUES
	(1,'Fine',8,-16,16,NULL,0.5,NULL,0.125,0.5,0,0),
	(2,'Diminutive',4,-12,12,0.5,1,0.125,1,1,0,0),
	(3,'Tiny',2,-8,8,1,2,1,8,2.5,0,0),
	(4,'Small',1,-4,4,2,4,8,60,5,5,5),
	(5,'Medium',0,0,0,4,8,60,500,5,5,5),
	(6,'Large',-1,4,-4,8,16,500,4000,10,10,5),
	(7,'Huge',-2,8,-8,16,32,4000,32000,15,15,10),
	(8,'Gargantuan',-4,12,-12,32,64,32000,250000,20,20,15),
	(9,'Colossal',-8,16,-16,64,NULL,250000,NULL,30,30,20);
